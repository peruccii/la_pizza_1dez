...
const selectAllPizzas = async () => {
    ...
    let sql = `select tbl_produto.nome,tbl_produto.foto as produtoFoto, tbl_produto.preco, tbl_produto.status_promocao, tbl_produto.status_favoritos, tbl_produto.id from tbl_produto
